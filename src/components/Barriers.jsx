import { FaShieldAlt, FaCog, FaBuilding } from 'react-icons/fa';
    ...
    <section className="section fade">
      ...
      <div className="barr-grid">
        <div className="barr-card fade">
          <span className="barr-emoji"><FaShieldAlt /></span>
        ...
        <div className="barr-card fade d1">
          <span className="barr-emoji"><FaCog /></span>
        ...
        <div className="barr-card fade d2">
          <span className="barr-emoji"><FaBuilding /></span>
